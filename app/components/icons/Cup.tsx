const Cup = ({fill} : {fill: string}) => {
  return (
    <svg width="34" height="40" viewBox="0 0 34 40" fill={fill} xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_58396_181)">
    ...
    <defs>
    <clipPath id="clip0_58396_181">
    <rect width="34" height="40" fill="inherit"/>
    </clipPath>
    </defs>
    </svg>
