const Folk = ({fill} : {fill: string}) => {
  return (
    ...
    >
      <rect opacity="0.01" width="56" height="56" fill="inherit" />
      <g clipPath="url(#clip0_58396_59)">
        <g clipPath="url(#clip1_58396_59)">
          <path
